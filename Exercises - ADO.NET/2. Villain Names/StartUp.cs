...
namespace _2._Villain_Names
{
    public class StartUp
    {
        ...
        static async Task<string> GetAllVillainsWithTheirMinionsAsync(SqlConnection sqlConnection)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand(SqlQueries.VillainNames, sqlConnection);
        ...
        //Problem 03
        static async Task<string> GetAllMinionsAndTheirAgeByTheVillainId(SqlConnection sqlConnection, int villainId)
        {

            StringBuilder sb = new StringBuilder();
            SqlCommand getVillainNameCommand
                = new(SqlQueries.GetVillainNameById, sqlConnection);
            ...
            SqlCommand getAllMinionsCommand
                = new(SqlQueries.GetAllMinionsAndTheirAgeByVillainId, sqlConnection);
